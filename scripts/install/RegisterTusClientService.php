...
use oat\taoSync\model\tusUpload\clients\GuzzleClientAdapter;
use oat\taoSync\model\tusUpload\LocalFileStorageService;
use oat\taoSync\model\tusUpload\TusUploadClientService;
use oat\taoSync\model\tusUpload\TusUploadClientServiceInterface;
    ...
    public function __invoke($params)
    {
        try {
            ...
            $tusUploadClientService = new TusUploadClientService([
                TusUploadClientService::OPTION_FILE_STORAGE        => new LocalFileStorageService(),
