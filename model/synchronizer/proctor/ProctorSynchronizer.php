...
namespace oat\taoSync\model\synchronizer\proctor;
...
class ProctorSynchronizer extends AbstractResourceSynchronizer
{
    ...
    public function fetch(array $options = [])
    {
        ...
        $joiner->setQuery($queryBuilder)
            ->join($queryBuilder2)
            ->on('http://www.tao.lu/Ontologies/TAOTestCenter.rdf#assignedProctor');
